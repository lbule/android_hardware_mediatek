...
/*
[ALPS00933997] [Need Patch] [Volunteer Patch] [Android 4.3 MR2 migration]wpa_supplicant_8
.
wfd enhancement
*/	
#ifdef CONFIG_MTK_P2P
	{
	   ...
	   p_wfd_data_cmd->WfdFlag &= ~WFD_FLAG_DEV_INFO_VALID;
		...
		if(global->p2p_init_wpa_s) {
			...
			wpa_drv_driver_cmd(global->p2p_init_wpa_s, "wfd_data_update", 
								(char *)(&global->wfd_data), sizeof(struct wfd_data_s));
...
#ifdef CONFIG_MTK_P2P
	global->wfd_data_cmd.WfdEnable = enabled;
#endif
