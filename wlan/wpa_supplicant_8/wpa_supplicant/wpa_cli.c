...
#ifdef CONFIG_MTK_P2P /* [ALPS00618361] [WFD Quality Enhancement] */
static int wpa_cli_cmd_testmode_get_sta_statistics(struct wpa_ctrl *ctrl, int argc, char *argv[])
{
	return wpa_cli_cmd(ctrl, "DRIVER GET_STA_STATISTICS", 1, argc, argv);
}
...
#ifdef CONFIG_MTK_P2P  /* [ALPS00618361] [WFD Quality Enhancement] */
	{ "get_sta_statistics", wpa_cli_cmd_testmode_get_sta_statistics, NULL,
	  cli_cmd_flag_none,
	  "<addr> = get link statistics from an associated station" },
#endif /*Mediatek Modified*/	
