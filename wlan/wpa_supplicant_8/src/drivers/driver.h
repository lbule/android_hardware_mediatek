...
enum nl80211_testmode_go_ready_attr{
    __NL80211_TESTMODE_GO_READY_INVALID = 0,
	NL80211_TESTMODE_GO_READY_STATE,
    NL80211_TESTMODE_GO_READY_NUM,
    NL80211_TESTMODE_GO_READY_MAX = NL80211_TESTMODE_GO_READY_NUM - 1
};
